import glitch_user_objects from "./glitch_user_objects"

export default class glitch_user_actions {
    constructor(page) {
        this.page = page
        this.locators = new glitch_user_objects(page)
    }
    ...
    async addToCart4() {
        await this.locators.cart4.click()
    }
    async clickCartIcon() {
    ...
    async getProduct4Name() {
        return await this.locators.product4.textContent()
    }   
    async checkProduct4Name() {
        return await this.locators.checkProduct4.textContent()
    }
    ...
    async getProduct4Price() {
        return await this.locators.price4.textContent()
    }   
    ...
    async sortZToA() {
        await this.locators.zToA.click()
    }
    async clickFilterButton() {
        await this.locators.filterButton.click()
    }
    async orderCompleteMessage() {
        return await this.locators.orderMessage.textContent()
    }
}
